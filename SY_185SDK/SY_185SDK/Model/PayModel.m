...
- (void)payStartWithCompletion:(void (^)(NSDictionary *, BOOL))completion {
    [PayModel payStartWithServerID:self.serverID serverName:self.serverNAME roleID:self.roleID roleName:self.roleNAME productID:self.productID productName:self.productNAME payType:self.payType payModel:self.payModel amount:self.amount extension:self.extend cardID:self.cardID cardPassword:self.cardPass cardMoney:self.cardMoney Completion:completion];
}
